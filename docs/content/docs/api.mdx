---
title: API Reference
description: Complete API reference for styled-cva exports, methods, and TypeScript utilities.
---
...
A utility function for combining Tailwind CSS classnames. It uses `cn` for intelligent merging and conflict resolution optimized for Tailwind CSS v4.
