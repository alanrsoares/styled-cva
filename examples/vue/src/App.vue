...
const VueLogoLink = tw.a`inline-flex p-4 font-medium text-[#646cff] no-underline hover:text-[#535bf2] transition-[filter] duration-300 hover:drop-shadow-[0_0_2em_#42b883aa]`
const LogoImg = tw.img`h-16 w-auto will-change-[filter]`
const VueLogoImg = tw.img`h-16 w-auto will-change-[filter]`
    ...
    <Header>
      <LogoRow>
        <LogoLink href="https://vite.dev" target="_blank">
          <LogoImg src="/vite.svg" alt="Vite" />
        </LogoLink>
        <VueLogoLink href="https://vuejs.org/" target="_blank">
          <VueLogoImg :src="vueLogo" alt="Vue" />
        </VueLogoLink>
      </LogoRow>
      <Title>styled-cva + Vue</Title>
      <Subtitle>Type-safe, CVA-based styled components for Vue with Tailwind</Subtitle>
    </Header>
    <Showcase />
  </Root>
</template>
