---
title: Testing
description: How to test styled-cva components using React Testing Library, Vitest, and Bun Test.
---
...
When using variant styles, you want to ensure that passing different variant props results in the correct class names being applied.
